  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-40 hidden md:flex items-center gap-2 px-3.5 py-2 rounded-full bg-neutral-900/90 border border-neutral-700/80 text-neutral-300 text-xs font-semibold shadow-xl hover:border-blue-500/60 hover:text-blue-300 transition-all backdrop-blur-md group"
      ...
      >
        ...
        <kbd className="px-1.5 py-0.5 rounded bg-neutral-800 border border-neutral-700 text-[10px] text-neutral-400 font-mono group-hover:border-blue-500/40">
          Ctrl K
        </kbd>
      </button>
    );
      ...
      <div className="w-full max-w-lg rounded-2xl bg-neutral-900 border border-neutral-800 shadow-2xl overflow-hidden">
        ...
        <div className="max-h-72 overflow-y-auto p-2 space-y-1 text-left">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-2 rounded-xl text-sm font-bold text-blue-300 bg-blue-500/10 border border-blue-500/30 hover:bg-blue-500/20 transition-colors text-left"
          >
            <span>⚙️ Open Web Admin Dashboard</span>
            <span className="text-xs text-blue-400/80">Ctrl+Shift+A</span>
          </button>
