                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 rounded-xl bg-neutral-50 border border-neutral-200">
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded text-xs font-bold bg-blue-500/15 border border-blue-500/30 text-blue-700 hover:bg-blue-500/25 transition-colors"
                    >
                      {copied ? "Copied!" : "Copy"}
                    </button>
                  </div>
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2 rounded-xl bg-neutral-50 border border-neutral-300 text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:border-blue-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2 rounded-xl bg-neutral-50 border border-neutral-300 text-sm text-neutral-900 placeholder-neutral-400 focus:outline-none focus:border-blue-500 resize-none"
                    />
                  </div>
